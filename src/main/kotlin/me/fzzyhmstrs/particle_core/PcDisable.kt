...
object PcDisable {
    ...
    class DisabledOptimizations {
        var _Disable_Optimizations_Options = mapOf(
            ...
            "TYPE" to "[Impact: Low to Medium] Disables mixins related to particle disabling and reduction (WorldRendererTypeMixin, ParticleManagerCreatorMixin, FireworksSparkParticleMixin)",
