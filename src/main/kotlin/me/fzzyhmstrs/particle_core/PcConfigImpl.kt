...
class PcConfigImpl: Config(Identifier.fromNamespaceAndPath("particle_core","particle_core_config"), "","") {
    ...
    private var byTypeReductions = ValidatedIdentifierMap(mapOf(), ValidatedIdentifier.ofRegistry(Identifier.withDefaultNamespace("smoke"), BuiltInRegistries.PARTICLE_TYPE), ValidatedDouble(1.0, 1.0, 0.0))
    ...
    private var cullingBlacklist = ValidatedIdentifier.ofRegistry(Identifier.withDefaultNamespace("smoke"), BuiltInRegistries.PARTICLE_TYPE).toSet()
