...
class PcConfigImpl: Config(Identifier("particle_core","particle_core_config"), "","") {
    ...
    private var byTypeReductions = ValidatedIdentifierMap(mapOf(), ValidatedIdentifier.ofRegistry(Identifier("smoke"), Registries.PARTICLE_TYPE), ValidatedDouble(1.0, 1.0, 0.0))
