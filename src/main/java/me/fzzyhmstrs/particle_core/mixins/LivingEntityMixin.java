...
public class LivingEntityMixin {
    ...
    @WrapWithCondition(method = "tickEffects", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/Level;addParticleClient(Lnet/minecraft/core/particles/ParticleOptions;DDDDDD)V"))
